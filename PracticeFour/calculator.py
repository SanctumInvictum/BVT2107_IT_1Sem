...
class Calculator(QWidget):
    ...
    def __init__(self):
        ...
        self.hbox_third.addWidget(self.b_division)
        ...
        self.hbox_fourth.addWidget(self.b_star)
        ...
        self.b_division.clicked.connect(lambda: self._button("/"))
        self.b_plus.clicked.connect(lambda: self._button("+"))
        self.b_float.clicked.connect(lambda: self._button("."))
        self.b_star.clicked.connect(lambda: self._button("*"))
